...
beforeEach(async () => {
  ...
  await factory.methods.createCampaign('100').send({ from: accounts[0], gas: '1300000' });
...
describe('Campaigns', () => {
  ...
  it('allows a manager to make a payment request', async () => {
    await campaign.methods
      .createRequest('Buy a car', '100', accounts[1])
      .send({ from: accounts[0], gas: '1300000' });
  ...
  it('processes requests', async () => {
    ...
    await campaign.methods.approveRequest(0).send({ from: accounts[0], gas: '1300000' });
    await campaign.methods.finalizeRequest(0).send({ from: accounts[0], gas: '1300000' });
